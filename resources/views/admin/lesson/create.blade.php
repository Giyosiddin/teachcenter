                     ...
                     <div class="card-header">
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          ...
                          <textarea id="inputBody" class="form-control ckeditor" name="body" rows="4"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="video">Video link</label>
                            <input type="text" required="required" id="video" required="required" name="video" class="form-control">
                          </div>
                      </div>
                  </div>
